...
we maintain single-thread (`@ffmpeg-wasm-browser/core`) and multi-thread version
...
| Name | Usage |
| ---- | ----- |
| @ffmpeg-wasm-browser/ffmpeg | ffmpeg.wasm main package |
| @ffmpeg/util | common utility functions |
| @ffmpeg/types | TypeScript types |
| @ffmpeg-wasm-browser/core | single-thread ffmpeg.wasm core |
